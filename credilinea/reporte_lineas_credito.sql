...
begin
	...
	for r in
      select 
		...
		(select max(po.fechapoliza) from polizas po,movipolizas mp,prestamos p1,tipoprestamo tp  where po.polizaid=mp.polizaid and mp.prestamoid=p1.prestamoid and p1.tipoprestamoid=tp.tipoprestamoid and mp.haber>0 and p1.prestamoid=p.prestamoid and (mp.cuentaid = tp.cuentaactivo or mp.cuentaid = tp.cuentaactivoren) and po.fechapoliza<=pfecha),
