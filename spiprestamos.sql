drop function if exists spiprestamos(bpchar, numeric, numeric, int4, date, date, bpchar, numeric, numeric, int4, int4, int4, int4, date, bpchar, numeric, bpchar, int4, int4, int4, int4, int4, int4, numeric);
