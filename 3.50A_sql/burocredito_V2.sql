...
begin
  ...
  for r in
	   ...
	   tp.revolvente,
	   (case when tp.revolvente=1 then (select pago_minimo from corte_linea where lineaid=p.prestamoid and fecha_corte<=pfecha limit 1) else 0 end ) as pago_minimo,
