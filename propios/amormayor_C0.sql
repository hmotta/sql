-- Se agrega los dias de pago 2 y 17 para el tipo N18
--Modo de uso SELECT * FROM sptablaamor(5000.000000,'2009-04-10','N18',10,15,0,0,'2009-03-14',21.000000);
-- Modificada 26 de Mayo de 2011 para el tipo de prestamos C0
...
if ptipoprestamoid not in ('N5 ','N17','N18','C0') then
