DROP TYPE tcondonaciones CASCADE;
CREATE TYPE tcondonaciones AS (
       ...
       iva numeric,
       -- Condonación Capital
       -- Condonación Ordinarios
       -- Condonación Moratorios       
...
CREATE or replace FUNCTION spscondonaciones(date, date, character, character) RETURNS SETOF tcondonaciones
    AS $_$
declare
  pfechai     alias for $1;
  pfechaf     alias for $2;
