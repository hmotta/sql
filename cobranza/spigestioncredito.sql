...
begin
	...
	insert into gestioncredito (prestamoid,numerodeatraso,resultadocobranzaid,etapa,usuariogestiona,fechagestion,horagestion) values(pprestamoid,nnumeroatraso,presultadocobranzaid,petapa,pusuariogestiona,pfechagestion,phoragestion);
