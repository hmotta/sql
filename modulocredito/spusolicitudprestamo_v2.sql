CREATE or replace FUNCTION spusolicitudprestamo(integer,integer,integer,character,character,character,integer,integer,numeric,numeric,numeric,integer,integer,integer,numeric,integer,numeric,numeric,date,date,character varying,integer,integer) RETURNS integer
    AS $_$
declare
