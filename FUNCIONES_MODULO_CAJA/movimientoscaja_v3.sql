...
begin
    ...
    loop
      ...
      if r.tipomovimientoid not in ('00','IN') then
        ...
        for l in
          select m.polizaid,t.cuentaactivo,t.cuentaactivoren,t.cuentaintnormal,t.cuentaintnormalren,t.cuentaintmora,t.cuentaintmoraren,t.cuentaiva
        ...
        loop
          ...
          select sum(coalesce(haber-debe,0)) into fcapital
           ...
           where polizaid = l.polizaid and
                 (cuentaid = l.cuentaactivo or cuentaid = l.cuentaactivoren) and debe=0;
          select sum(coalesce(haber-debe,0)) into fnormal
            from movipolizas
           where polizaid = l.polizaid and
                 (cuentaid = l.cuentaintnormal or cuentaid = l.cuentaintnormalren);
          select sum(coalesce(haber-debe,0)) into fmoratorio
            from movipolizas
           where polizaid = l.polizaid and
                 (cuentaid = l.cuentaintmora or cuentaid = l.cuentaintmoraren);
