...
--
drop TYPE rtipooperacion cascade;
CREATE TYPE rtipooperacion AS (
	 tipooperacion character varying(2)
);

CREATE or replace FUNCTION spstipooperacion(character varying) RETURNS SETOF rtipooperacion
    AS $_$
declare
