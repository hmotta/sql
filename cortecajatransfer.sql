-- ----------------------------
-- Function structure for cortecajatransfer
-- ----------------------------
DROP FUNCTION IF EXISTS cortecajatransfer(bpchar, date, int4);
CREATE OR REPLACE FUNCTION cortecajatransfer(bpchar, date, int4)
