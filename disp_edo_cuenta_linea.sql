Drop type rdisposicioneslinea cascade;
CREATE TYPE rdisposicioneslinea AS (
	fecha date,
	folio character(2),
	nopoliza integer,
...
CREATE or replace FUNCTION disp_edo_cuenta_linea(integer,date,date,integer) RETURNS SETOF rdisposicioneslinea
    AS $_$
declare
