...
begin
  ...
  if pmiles=1 then
	...
	pcf:=(saldocuenta('2102 ',pejercicio,pperiodo,sconsolida)-saldocuenta('2102010202 ',pejercicio,pperiodo,sconsolida)-saldocuenta('2102010203 ',pejercicio,pperiodo,sconsolida))*-1;
	if pmiles=1 then
		pcf:=pcf/1000.00;
	end if;
	r.rubro1:=NULL;
    ...
    pas_cap:=saldocuenta('2101 ',pejercicio,pperiodo,sconsolida)*-1 +
    		 (saldocuenta('2102 ',pejercicio,pperiodo,sconsolida)-saldocuenta('2102010202 ',pejercicio,pperiodo,sconsolida)-saldocuenta('2102010203 ',pejercicio,pperiodo,sconsolida))*-1 +
    ...
    if pmiles=1 then
 	...
 	pcf:=saldocuenta('2305',pejercicio,pperiodo,sconsolida)*-1 +
		 ...
		 saldocuenta('2102010202',pejercicio,pperiodo,sconsolida)*-1 +
		 saldocuenta('2102010203',pejercicio,pperiodo,sconsolida)*-1;
	if pmiles=1 then
		pcf:=pcf/1000.00;
	end if;
