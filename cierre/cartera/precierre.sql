--Modificado el 30-11-2010 para validar los dias de gracia
--Recuperado el 11-11-2010

CREATE OR REPLACE FUNCTION precierre(date)
  RETURNS integer AS
$BODY$
declare
...
CREATE OR REPLACE FUNCTION fechaultimapagada(integer, date)
  RETURNS date AS
$BODY$
declare
