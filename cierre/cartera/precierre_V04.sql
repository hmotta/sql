...
--<<--
   ...
   -->>Se agrega a vigente o vencida de acuerdo a la variable diasvencidos
	...
	update precorte p set diastraspasoavencida=21 where fechacierre=pfechacorte and (select numero_de_amor from prestamos where prestamoid=p.prestamoid)>1 and  frecuencia=7 and tipoprestamoid not in ('T1','T2','T3','R1','R2','R3');
	...
	update precorte p set diastraspasoavencida=45 where fechacierre=pfechacorte and (select numero_de_amor from prestamos where prestamoid=p.prestamoid)>1 and  frecuencia=15 and tipoprestamoid not in ('T1','T2','T3','R1','R2','R3');
	
	---------> Distintos a (Semanal,Quincenal) Vigentes
	update precorte p set saldovencidomenoravencido=saldoprestamo, saldovencidomayoravencido=0 where fechacierre=pfechacorte and (select numero_de_amor from prestamos where prestamoid=p.prestamoid)>1 and  frecuencia not in (7,15) and diasvencidos<90;
	---------> Distintos a (Semanal,Quincenal) Vencidos
	update precorte p set saldovencidomenoravencido=0,saldovencidomayoravencido=saldoprestamo where fechacierre=pfechacorte and (select numero_de_amor from prestamos where prestamoid=p.prestamoid)>1 and  frecuencia not in (7,15) and diasvencidos>=90;
	
	update precorte p set diastraspasoavencida=90 where fechacierre=pfechacorte and (select numero_de_amor from prestamos where prestamoid=p.prestamoid)>1 and  frecuencia=15 and frecuencia not in (7,15) and  tipoprestamoid not in ('T1','T2','T3','R1','R2','R3');
