...
--Parche por redondeo 2014/06/30
--update catalogominimo2 set saldo=round(saldo)+1 where cuentasiti='110100000000';

--Parche por redondeo 2014/07/31
--update catalogominimo2 set saldo=round(saldo)-1 where cuentasiti='640800000000';

--Parche por redondeo 2014/08/31
--update catalogominimo2 set saldo=round(saldo)+2 where cuentasiti='640800000000';

--Parche por redondeo 2014/09/30
--update catalogominimo2 set saldo=round(saldo)+1 where cuentasiti='640800000000';

--Parche por redondeo 2014/10/31
--update catalogominimo2 set saldo=round(saldo)-1 where cuentasiti='640800000000';

--Parche por redondeo 2014/12/31
--update catalogominimo2 set saldo=round(saldo)-2 where cuentasiti='640800000000';

--Parche por redondeo 2015/01/31
--update catalogominimo2 set saldo=round(saldo)-2 where cuentaid='230521';
--update catalogominimo2 set saldo=round(saldo)+2 where cuentasiti='110100000000';

--Parche por redondeo 2015/02/28
--update catalogominimo2 set saldo=round(saldo)+2 where cuentaid='23051602';

--Parche por redondeo 2015/03/31
--update catalogominimo2 set saldo=round(saldo)+1 where cuentasiti='110100000000';

--Parche por redondeo 2015/03/31
--update catalogominimo2 set saldo=round(saldo)+3 where cuentasiti='110100000000';

--Parche por redondeo 2015/06/30
--update catalogominimo2 set saldo=round(saldo)+2 where cuentasiti='110100000000';

--Parche por redondeo 2015/07/31
--update catalogominimo2 set saldo=round(saldo)-2 where cuentaid='230511';
--update catalogominimo2 set saldo=round(saldo)+1 where cuentasiti='110100000000';
--update catalogominimo2 set saldo=round(saldo)+2 where cuentasiti='640800000000';

--Parche por redondeo 2015/08/31
--update catalogominimo2 set saldo=round(saldo)+3 where cuentasiti='640800000000';
--update catalogominimo2 set saldo=round(saldo)+3 where cuentasiti='160105000000';

--Parche por redondeo 2015/09/30
--update catalogominimo2 set saldo=round(saldo)+3 where cuentasiti='640800000000';
--update catalogominimo2 set saldo=round(saldo)+3 where cuentasiti='160105000000';
...
--Parche por redondeo 2015/12/31
update catalogominimo2 set saldo=round(saldo)+2 where cuentasiti='640800000000';
--Parche por redondeo 2015/12/31
update catalogominimo2 set saldo=round(saldo)+1 where cuentasiti='110100000000';
