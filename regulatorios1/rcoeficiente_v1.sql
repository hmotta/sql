...
-- Calculo de B
  ...
  fbancos := round(saldocuenta('11',iejercicio,iperiodo,sconsolida));                       -- 3
...
--  r.b := NULL;
 ...
 -- r.b := ftitulosalvencimientoprom + fbancosprom;
  ...
  r.concepto1 := NULL;
  r.concepto2:='3.Disponibilidades';
  r.concepto3 := null;
  r.a := fbancos;
--  r.b := fbancosprom;
  r.b := null;
  ...
  r.concepto1 := NULL;
  r.concepto2:='4.Inversiones en valores con vencimiento menor o igual a 30 dias 2/';
  r.concepto3 := null;
...
--  r.b := 0;
 ...
 r.concepto1 := NULL;
  ...
  r.concepto1 := NULL;
  r.concepto2 := '5. Deudores por reporto con vencimiento menor o igual a 30 dias';  
  r.concepto3:=NULL;
  r.a:= NULL;
  r.b := null;
