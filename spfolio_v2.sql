...
--          pdescripcion := coalesce(pdescripcion,' ');
          ...
          ||rpad(pdescripcion,20,' ')||lpad(to_char(r.cantidad,'999,999,999.99'),44,' ')||chr(13)||chr(10);
...
-- Inversiones
  ...
  select t.cuentapasivo,t.cuentaintinver,t.cuentaivainver,t.cuentariesgocred,m.polizaid
   ...
   if pencabezado <> 0 then
	...
	if denomina = 16 then
	         esefectivo = 'TRANSFERENCIA INTERNA';
	    end if;
	if denomina = 18 then
	         esefectivo = 'TRANSFERENCIA BANCARIA';
	    end if;
	...
	pformato := pformato||'  INVERSION'||chr(13)||chr(10)||
		  '  PAGO CON          '||esefectivo||chr(13)||chr(10)||chr(13)||chr(10)||
   ...
   if pencabezado <> 5 then
	...
	if denominaretiro = 18 then
         ...
         if 	denominaretiro> 14 then
	   	...
	   	ptexto := chr(13)||chr(10)||'   TOTAL A PAGAR '||to_char(subtotal,'$999,999.99')||
                          chr(13)||chr(10)||'   RETIRO CON          '||esefectivo||chr(13)||chr(10);
	else
