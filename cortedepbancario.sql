CREATE OR REPLACE FUNCTION cortecajadepbancario(character, date, integer) RETURNS SETOF rcortecaja
    AS $_$
declare
 pserie alias for $1;
 pfecha alias for $2;
...
ALTER FUNCTION public.cortecajadepbancario(character, date, integer) OWNER TO sistema;
