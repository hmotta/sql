...
for f in
 select * from sucursales where vigente='S'
  ...
  loop
	...
	fecha_baja character(15),								--29
	persona_moral character(15),
	telefono 	character varying(15)								--30
)
